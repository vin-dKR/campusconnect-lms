    ...
    return (
        <>
            ...
            <motion.div
                initial={false}
                animate={{
                    x: isOpen ? 0 : (isCollapsed ? 0 : 0),
                    width: isCollapsed ? 80 : 280
                }}
                transition={{ type: "spring", damping: 30, stiffness: 300 }}
                className="fixed lg:sticky top-0 left-0 h-screen bg-white dark:bg-slate-900 z-50 flex flex-col border-r border-slate-200 dark:border-slate-800"
            >
                {/* Header */}
                <div className={cn(
                    ...
                    <div className={cn(
                        ...
                        <div className="flex items-center space-x-2">
                            <button
                                ...
                                className="hidden lg:flex p-1 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
                            >
